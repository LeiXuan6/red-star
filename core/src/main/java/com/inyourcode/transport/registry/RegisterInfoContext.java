...
public class RegisterInfoContext {
    ...
    public ConfigWithVersion<ConcurrentMap<RegisterMeta.Address, RegisterMeta>> getRegisterMeta
        ...
        if (config == null) {
            ...
            newConfig.setConfig(new ConcurrentHashMap<RegisterMeta.Address, RegisterMeta>());
