...
import com.inyourcode.transport.api.channel.DirectoryJChannelGroup;
...
public abstract class NettyConnector implements JConnector<JConnection> {
    ...
    private final ConcurrentMap<UnresolvedAddress, JChannelGroup> addressGroups = new ConcurrentHashMap<>();
